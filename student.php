...
<body>
	<div class="col-sm-12">
		...
		<h6 class=" mg-clear tc-1">
			<a class="pull-left" href="https://engg.kkwagh.edu.in/" target="_blank"> K. K. Wagh Institute of Engineering Education & Research, Nashik
			</a><br>
		</h6>
	</div>
	</div>
	...
	<div class="col-sm-2">
		<h4 class="mg-md bloc-mob-center-text  tc-dim-gray">
			...
			<a href="https://drive.google.com/file/d/1N8JH2rH8K-6LcufGfK0gVMBz9HNhPQgu/view?usp=sharing" class="a-btn a-block bloc-mob-center-text">Our Recruiters</a><br>
		</h4>
	</div>
